...
class mfnSystemStatus {
	...
	function init() {
		...
		if( WHITE_LABEL ){
			...
			// White Label | Hide 'System Status' Page
			add_theme_page(
				__( 'System Status','mfn-opts' ),
				__( 'System Status','mfn-opts' ),
				'edit_theme_options',
				'system_status',
				array( &$this, 'system_white' )
			);
	 ...
	 * White Label | Hide 'System Status' Page
	 * ---------------------------------------------------------------------------- */
	function system_white() {
		?>
			<div id="mfn-wrapper" class="mfn-system wrap">
...
$mfnSystemStatus = new mfnSystemStatus;
?>